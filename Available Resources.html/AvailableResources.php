...
<nav class="navbar" style="position: fixed; width: 100%;">
  <div class="navbar__container">
    ...
    <ul class="navbar__menu">
      ...
      <li class="navbar__item">
        <a href="#" class="navbar__links" id="AvailableResources-page">Available Resources</a>
      </li>
      <li class="navbar__item">
...
<br>
<h1 style="text-align: center; position:relative; width: 100%;">Available Resources</h1>
<br>
