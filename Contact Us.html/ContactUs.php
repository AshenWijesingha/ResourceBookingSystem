...
<nav class="navbar" style="position: fixed; width: 100%;">
  <div class="navbar__container">
    ...
    <ul class="navbar__menu">
      ...
      <li class="navbar__item">
        <a href="#" class="navbar__links" id="ContactUs-page">Contact Us</a>
      </li>
...
<br>
<h1 style="text-align: center; position: relative; width: 100%;">Contact Us</h1>
<br>

<div id="devCont_top" style="height: 35rem">  
  <div
